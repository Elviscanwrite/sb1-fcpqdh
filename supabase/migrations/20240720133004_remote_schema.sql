-- Drop existing collections table if it exists
...
CREATE TABLE "public"."collections" (
    ...
    "type" text NOT NULL CHECK (type IN ('featured', 'overview', 'news', 'research')),
    ...
    "custom_layout" text CHECK (custom_layout IN ('default', 'split', 'fullscreen', 'dashboard')),
    "custom_styles" text,
